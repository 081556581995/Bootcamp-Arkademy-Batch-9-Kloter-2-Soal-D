...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h3>Tambah Data Regions</h3><a href="index_r.php" class="btn btn-info">Lihat Data</a><hr>
          ...
          <div class="form-group">
				...
				if (isset($_POST["simpan"])) {
					$simpan = mysql_query("INSERT INTO regions ( id, name, created_at ) VALUES ('$_POST[id]', '$_POST[name]', '$_POST[created_at]')");
					if ($simpan) {
