...
<div class="container">
	<div class="row">
      ...
      <div class="form-group">
          <label>E mail</label>
          <input type="text" class="form-control" name="email" value="<?php echo $tampil['email'];?>" required autofocus>
      </div>
      <div class="form-group">
          <label>Password</label>
          <input type="text" class="form-control" name="password" value="<?php echo $tampil['password'];?>" required autofocus>
      </div>
      <div class="form-group">
        ...
        <input type="reset" value="Reset" class="btn btn-danger">
			...
			<?php
				if (isset($_POST["simpan"])) {
					$simpan = mysql_query("UPDATE regions SET id = '$_POST[id]',email = '$_POST[email]',password = '$_POST[password]', created_at = '$_POST[created_at]'WHERE id = '$_POST[id]'");
					if ($simpan) {
