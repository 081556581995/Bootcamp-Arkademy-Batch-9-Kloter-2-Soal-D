...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h3>Tambah Data User</h3><a href="index_u.php" class="btn btn-info">Lihat Data</a><hr>
          ...
          <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="created_at" required autofocus>
					</div>
					<div class="form-group">
				...
				if (isset($_POST["simpan"])) {
					$simpan = mysql_query("INSERT INTO user ( id, email, password, created_at ) VALUES ('$_POST[id]', '$_POST[email]', '$_POST[password]', '$_POST[created_at]')");
					if ($simpan) {
