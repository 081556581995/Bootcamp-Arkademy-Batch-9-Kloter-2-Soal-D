...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			<h2>Regions</h2><a href="tambah_r.php" class="btn btn-success">Tambah</a>
		</div>
	</div>
	<div class="row">
		<div class="col-md-8">
          ...
          <tbody>
            ...
            <td>$tampil[name]</td>
						...
						<td>
						<a href='edit_r.php?id=$tampil[id]' class='btn btn-info'>EDIT</a>
						<a href='hapus_r.php?id=$tampil[id]'
