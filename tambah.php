...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			<h3>Tambah Data Person</h3><a href="index_p.php" class="btn btn-info">Lihat Data</a><hr>
          ...
          <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="region_id" disabled>
					</div>
          <div class="form-group">
					    <label>Address</label>
					...
					<div class="form-group">
					    <label>Income</label>
					    <input type="text" class="form-control" name="income" required autofocus>
					</div>
          <div class="form-group">
					    <label>Created at</label>
					    <textarea class="form-control" required name="created_at"></textarea>
					</div>
					<div class="form-group">
				...
				if (isset($_POST["simpan"])) {
					$simpan = mysql_query("INSERT INTO person ( id, name, region_id, address, income, created_at ) VALUES ('$_POST[id]', '$_POST[name]', '$_POST[region_id]', '$_POST[address]', '$_POST[income]', '$_POST[created_at]')");
					if ($simpan) {
